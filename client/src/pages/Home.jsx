    ...
    <div className="flex flex-col pb-20">
      ...
      <section className="py-20 md:py-32 flex flex-col items-center gap-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        <div className="relative flex flex-col items-center">
          <div
            className="absolute inset-0 bg-gradient-to-tr from-primary/20 to-transparent blur-3xl rounded-full w-3/4 h-3/4 m-auto -z-10 animate-pulse"
            style={{
        ...
        <div className="flex flex-col items-center text-center gap-4">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed mt-2">
            ...
            building a strong technical mindset.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mt-6">
            <Link href="/about">
              <Button
                size="lg"
                className="bg-primary hover:bg-secondary text-white rounded-full px-8 h-14 text-base shadow-[0_4px_20px_rgba(198,167,94,0.3)] hover:shadow-[0_8px_30px_rgba(168,137,61,0.4)] transition-all"
              >
                Learn More
              </Button>
            </Link>
            <Link href="/events">
              <Button
                size="lg"
                variant="outline"
                className="rounded-full px-8 h-14 text-base border-primary/20 hover:bg-primary/5 hover:text-primary transition-all"
              >
                Explore Events
              </Button>
            </Link>
      ...
      <section className="py-20 bg-card rounded-3xl px-8 md:px-16 my-10 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="space-y-6 text-muted-foreground leading-relaxed text-lg text-left md:text-center">
            <p>
              DSaC is a student-led technical club of passionate learners,
              developers, and problem-solvers united by a shared love for
              technology. We are dedicated to strengthening problem-solving
              skills and fostering a strong coding culture within our college.
            </p>
            <p>
              Our mission is to nurture curiosity, encourage collaboration, and
              help students develop strong analytical and technical abilities.
              Through peer learning, mentorship, and hands-on practice, we
              create a supportive space where students can explore technology
              beyond academics and continuously grow.
            </p>
            <p className="font-serif text-2xl text-secondary mt-8 italic">
              "DSaC is more than a club — it's a community that believes in
              learning together, building confidence, and developing the mindset
              needed to thrive in the evolving world of technology."
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Elevate your technical journey with our structured approach to
