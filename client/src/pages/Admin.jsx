...
export default function Admin() {
  ...
  const fetchSpecialQuestions = async () => {
    setLoading(true);
    try {
      const res = await fetch(`${API_BASE}/admin/special-questions`, {
        headers,
      });
      const data = await res.json();
  ...
  const handleAddSpecialQuestion = async (e) => {
    ...
    try {
      ...
      showMessage("Error adding special question");
    }
  };
  ...
  const handleAddResource = async (e) => {
    ...
    const fullCategory = resSubcategory
  ...
  const handleDeleteResource = async (id) => {
    ...
    try {
      ...
      showMessage("Error deleting resource");
    }
  };
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Manage users, questions, and resources
          </p>
        </div>
      </div>
          ...
          {activeTab === "special" && (
            <div className="space-y-6">
              <Card className="border-border/50 shadow-sm">
                ...
                <CardContent>
                  <form
                    onSubmit={handleAddSpecialQuestion}
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        value={sqLink}
                        onChange={(e) => setSqLink(e.target.value)}
                  ...
                  {specialQuestions.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      {specialQuestions.map((q) => (
                        <div
                          key={q._id}
                          className="flex items-center justify-between p-3 rounded-lg border border-border/40 hover:bg-muted/30"
                        >
                          <div>
                ...
                <CardContent>
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        value={resYoutubeId}
                        onChange={(e) => setResYoutubeId(e.target.value)}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        value={resGfgLink}
                        onChange={(e) => setResGfgLink(e.target.value)}
                        ...
                        >
                          <div>
                            ...
                            <div className="flex items-center gap-2 text-xs text-muted-foreground mt-1">
                              ...
                              <Badge
                                variant="outline"
                                className={`text-xs ${r.difficulty === "Easy" ? "text-green-500" : r.difficulty === "Medium" ? "text-amber-500" : "text-red-500"}`}
                              >
                                {r.difficulty}
                              </Badge>
