    ...
    <div className="flex flex-col pb-20">
      ...
      <section className="py-16 md:py-24 animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-3xl leading-relaxed">
          Data Structures and Algorithms Club — a student-led technical
          community founded in 2024, united by a shared love for technology and
          problem-solving.
        </p>
      </section>
      ...
      >
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <motion.div
            variants={fadeUp}
            custom={1}
            className="space-y-6 text-muted-foreground leading-relaxed text-lg text-left md:text-center"
          >
            <p>
              DSAC (Data Structures and Algorithms Club) is a student-led
              technical club founded in 2024. It is a community of passionate
              learners, developers, and problem-solvers united by a shared love
              for technology. DSAC focuses on strengthening problem-solving
              skills and fostering a strong coding culture within the college.
            </p>
          </motion.div>
        </div>
      </motion.section>
      ...
      >
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          >
            ...
            encouraging collaboration, and helping students develop strong
            analytical and technical abilities. Through peer learning,
            mentorship, and hands-on practice, we create a supportive space
            where students explore technology beyond academics and continuously
            grow.
          </motion.p>
          <motion.p
            variants={fadeUp}
            custom={3}
            className="font-serif text-2xl text-secondary mt-8 italic max-w-3xl mx-auto"
          >
      ...
      >
        <motion.div variants={fadeUp} custom={0} className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            From weekly practice to hackathons, here's how we keep the momentum
            going.
          </p>
        </motion.div>
