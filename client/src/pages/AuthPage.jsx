          ...
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription>
              {mode === "login"
                ...
                : "Join the club and start your coding journey"}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {mode === "signup" && (
                <div className="space-y-3 pt-2 border-t border-border/40">
                  <p className="text-sm font-medium text-muted-foreground">
                    Platform IDs{" "}
                    <span className="text-xs">(optional — can add later)</span>
                  </p>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                      <Label htmlFor="leetcodeId" className="text-xs">
                        LeetCode
                      </Label>
                      <Input
                        id="leetcodeId"
                    ...
                    <div className="space-y-1">
                      <Label htmlFor="codechefId" className="text-xs">
                        CodeChef
                      </Label>
                      <Input
                        id="codechefId"
                    ...
                    <div className="space-y-1">
                      <Label htmlFor="hackerrankId" className="text-xs">
                        HackerRank
                      </Label>
                      <Input
                        id="hackerrankId"
              ...
              <Button
                type="submit"
                className="w-full bg-primary hover:bg-secondary text-white rounded-lg h-11 font-medium"
                disabled={isLoading}
              >
                {isLoading ? (
