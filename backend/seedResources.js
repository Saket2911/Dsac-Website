...
const resources = [
  ...
  {
    title: "Arrays Explained - Full Tutorial",
    category: "Data Structures > Arrays",
    youtubeVideoId: "QJNwK2uJyGs",
  ...
  },
  {
    ...
    category: "Data Structures > Arrays",
    youtubeVideoId: "VMtyGnNcdNw",
    gfgLink: "https://www.geeksforgeeks.org/largest-sum-contiguous-subarray/",
    difficulty: "Medium",
    order: 2,
  },
  {
    title: "Rotate Array - Multiple Approaches",
    category: "Data Structures > Arrays",
    youtubeVideoId: "BHr381Guz3Y",
  ...
  // ===== DATA STRUCTURES > TWO POINTER =====
  {
    ...
    category: "Data Structures > Two Pointer",
    youtubeVideoId: "On03HWe2tZM",
    gfgLink: "https://www.geeksforgeeks.org/two-pointers-technique/",
    difficulty: "Easy",
    order: 1,
  },
  {
  ...
  },
  {
    ...
    category: "Data Structures > Two Pointer",
    youtubeVideoId: "UuiTKBwPgAo",
    gfgLink: "https://www.geeksforgeeks.org/container-with-most-water/",
    difficulty: "Medium",
    order: 3,
  },
  {
    title: "3Sum Problem - Find Triplets",
    category: "Data Structures > Two Pointer",
    youtubeVideoId: "jzZsG8n2R9A",
    gfgLink:
  ...
  },
  {
    ...
    category: "Data Structures > Stacks & Queues",
    youtubeVideoId: "W81jJBkFSGo",
    gfgLink: "https://www.geeksforgeeks.org/queue-data-structure/",
    difficulty: "Easy",
    order: 2,
  },
  {
  ...
  {
    title: "Binary Tree Bootcamp - Full Course",
  ...
  {
    title: "Binary Search Tree (BST) Complete",
    category: "Data Structures > Trees",
    youtubeVideoId: "cySVml6e_Fc",
    gfgLink: "https://www.geeksforgeeks.org/binary-search-tree-data-structure/",
    difficulty: "Medium",
    order: 2,
  },
  {
  ...
  },
  {
    ...
    category: "Algorithms > Binary Search",
    youtubeVideoId: "W9QJ8HaRvJQ",
    gfgLink:
      "https://www.geeksforgeeks.org/binary-search-on-answer-tutorial-with-practice-problems/",
    difficulty: "Medium",
    order: 2,
  },
  {
  ...
  // ===== ALGORITHMS > GRAPHS =====
  {
    title: "Graph Theory Full Course",
  ...
  {
    title: "Recursion Full Course for Beginners",
    category: "Algorithms > Recursion & Backtracking",
    youtubeVideoId: "IJDJ0kBx2LM",
    gfgLink:
  ...
  // ===== COMPETITIVE PROGRAMMING > TIPS =====
  {
    ...
    category: "Competitive Programming > Getting Started",
    youtubeVideoId: "bVKHRtafgPc",
    gfgLink:
  ...
  {
    title: "Top 10 CP Tricks You Must Know",
    category: "Competitive Programming > Getting Started",
    youtubeVideoId: "y7169jEvb-Y",
    gfgLink:
      "https://www.geeksforgeeks.org/tips-and-tricks-for-competitive-programmers/",
    difficulty: "Easy",
    order: 2,
  },
];
...
async function seedResources() {
  ...
  console.log(
    `✅ Seeded ${resources.length} resources across ${new Set(resources.map((r) => r.category.split(" > ")[0])).size} categories`,
  );
